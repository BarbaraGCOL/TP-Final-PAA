 ...
 *
 */
public class SeqTest2 extends GPProblem {
	...
	public SeqTest2() throws InvalidConfigurationException, IOException {
	...
	public GPGenotype create() throws InvalidConfigurationException {
		...
		CommandGene[] cgs = new CommandGene[size + 11];
		...
		If se = new If(config, CommandGene.DoubleClass);
		IfElse senao = new IfElse(config, CommandGene.DoubleClass);
	...
	public static void main(String[] args) throws Exception {
		...
		for(int file = 0; file < files.length; file++){
			...
			GPProblem problem = new SeqTest2();
